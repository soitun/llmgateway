...
Current pricing follows Google’s official paid-tier Veo 3.1 pricing:

| Model                           | Default price    | 4K price         |
| ------------------------------- | ---------------- | ---------------- |
| `veo-3.1-generate-preview`      | `$0.40 / second` | `$0.60 / second` |
| `veo-3.1-fast-generate-preview` | `$0.15 / second` | `$0.35 / second` |
