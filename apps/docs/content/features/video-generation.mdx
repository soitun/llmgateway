...
Veo 3.1 is currently available through `obsidian` for 720p and `avalanche` for 1080p and 4k.
...
| ------------------------------- | ----------- | ------------------------ | ---------------- |
| `veo-3.1-generate-preview`      | `obsidian`  | `1280x720`, `720x1280`   | `$0.40 / second` |
| `veo-3.1-fast-generate-preview` | `obsidian`  | `1280x720`, `720x1280`   | `$0.15 / second` |
